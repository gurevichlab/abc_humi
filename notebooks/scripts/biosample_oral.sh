...
# Input file path
input_file="files/sampleoral.txt"
...
while IFS=$'\t' read -r -a columns; do
    ...
    python3 "$python_script" -s "$column2" --out files/biosamples_data/biosamples_ids_oral/"$output_file" -e alex.kushnareva99@gmail.com
